// ============================================
// SELBSTTEST — Die Verwandlung (BAC germană maternă)
// Claudia Toth · 14 Fragen (Werk · Figuren · Themen/Symbole · Aufbau · Deutung · Schreiben)
// Conținut german; UI în RO (elevi români, secție germană).
// ============================================

const finalTestData = [
    // 📖 Werk (3)
    { type: 'multiple', category: '📖 Werk', question: 'Zu welcher Epoche gehört „Die Verwandlung"?', options: ['Romantik', '(frühe) Moderne', 'Barock', 'Klassik'], correct: '(frühe) Moderne', explanation: 'Veröffentlicht 1915; dem Expressionismus nahe, mit Kafkas eigenem Stil („kafkaesk").' },
    { type: 'multiple', category: '📖 Werk', question: 'Welcher Gattung gehört das Werk an?', options: ['Roman', 'Erzählung (Novelle)', 'Drama', 'Ballade'], correct: 'Erzählung (Novelle)', explanation: 'Eine Erzählung in drei Kapiteln.' },
    { type: 'luckentext', category: '📖 Werk', question: 'Ergänze den Familiennamen des Autors:', sentence: 'Der Autor heißt Franz <strong>______</strong>.', translation: '1883–1924, Prag', accept: ['kafka'], correct: 'Kafka', explanation: 'Franz Kafka (1883–1924).' },

    // 👥 Figuren (3)
    { type: 'multiple', category: '👥 Figuren', question: 'Wer ist der Protagonist?', options: ['der Prokurist', 'Gregor Samsa', 'der Vater', 'Grete'], correct: 'Gregor Samsa', explanation: 'Gregor Samsa, der Handelsreisende, der sich in ein Ungeziefer verwandelt.' },
    { type: 'luckentext', category: '👥 Figuren', question: 'Ergänze den Namen:', sentence: 'Gregors Schwester heißt <strong>______</strong>.', translation: 'sora lui', accept: ['grete'], correct: 'Grete', explanation: 'Grete — pflegt ihn zuerst, wendet sich dann ab; am Ende „aufgeblüht".' },
    { type: 'multiple', category: '👥 Figuren', question: 'Wer verletzt Gregor mit einem Apfel?', options: ['die Mutter', 'der Vater', 'der Prokurist', 'die Bedienerin'], correct: 'der Vater', explanation: 'Der Apfel bleibt in Gregors Rücken stecken — väterliche Gewalt &amp; Schuld.' },

    // 🎯 Themen & Symbole (3)
    { type: 'multiple', category: '🎯 Themen', question: 'Was ist das zentrale Thema der Erzählung?', options: ['die Liebe', 'die Entfremdung', 'der Krieg', 'die Natur'], correct: 'die Entfremdung', explanation: 'Gregor ist entfremdet — von Arbeit, Familie, Körper und sich selbst.' },
    { type: 'multiple', category: '🎭 Symbole', question: 'Was symbolisiert das Ungeziefer?', options: ['Reichtum', 'die Entfremdung und Ausgrenzung des Menschen', 'die Liebe', 'die Religion'], correct: 'die Entfremdung und Ausgrenzung des Menschen', explanation: 'Bewusst unbestimmt; der Mensch, der zum „Ekel" und Außenseiter wird.' },
    { type: 'luckentext', category: '🎭 Symbole', question: 'Ergänze (väterliche Gewalt):', sentence: 'Der Vater verletzt Gregor schwer mit einem <strong>______</strong>.', translation: 'fruct', accept: ['apfel', 'apple'], correct: 'Apfel', explanation: 'Der Apfel bleibt in Gregors Rücken stecken und beschleunigt seinen Verfall.' },

    // 🏗️ Aufbau (2)
    { type: 'multiple', category: '🏗️ Aufbau', question: 'Aus wessen Sicht wird überwiegend erzählt?', options: ['aus Sicht des Vaters', 'aus Gregors Sicht (personale Erzählsituation)', 'aus Sicht eines Ich-Erzählers', 'aus Sicht der Zimmerherren'], correct: 'aus Gregors Sicht (personale Erzählsituation)', explanation: 'Er-Erzähler mit Innensicht Gregors — nach seinem Tod wechselt der Blick zur Familie.' },
    { type: 'multiple', category: '🏗️ Aufbau', question: 'Wie nennt man Kafkas typischen Stil?', options: ['romantisch', 'kafkaesk', 'klassisch', 'barock'], correct: 'kafkaesk', explanation: 'Nüchtern erzählt, rätselhaft, ausweglos und bedrohlich.' },

    // 💡 Deutung (2)
    { type: 'luckentext', category: '💡 Deutung', question: 'Ergänze den Stilbegriff:', sentence: 'Eine nüchtern erzählte, rätselhafte und ausweglose Welt nennt man <strong>______</strong>.', translation: 'tipic Kafka', accept: ['kafkaesk'], correct: 'kafkaesk', explanation: 'Der Begriff geht auf Kafkas eigene Erzählweise zurück.' },
    { type: 'multiple', category: '💡 Deutung', question: 'Wie endet die Erzählung?', options: ['Gregor wird wieder Mensch', 'Gregor stirbt, und die erleichterte Familie plant einen Neuanfang', 'die Familie stirbt', 'Gregor zieht aus'], correct: 'Gregor stirbt, und die erleichterte Familie plant einen Neuanfang', explanation: 'Die „aufgeblühte" Grete soll bald heiraten — ein verstörend kalter Schluss.' },
...
function buildFinalTest() {
    ...
    container.innerHTML = `
        <div id="test-intro" class="test-intro">
            ...
            <p>Selbsttest mit <strong>${finalTestData.length} Fragen</strong> über <em>Die Verwandlung</em> (Werk, Figuren, Themen, Symbole, Aufbau, Deutung, Schreiben).</p>
            <ul class="test-info-list">
                <li>📖 Werk · 👥 Figuren · 🎯 Themen &amp; Symbole · 🏗️ Aufbau · 💡 Deutung · ✍️ Schreiben</li>
